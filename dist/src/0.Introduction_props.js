...
export default {
    ...
    'updated': "2021-09-15T09:50:55.000Z",
    'excerpt': "目录 1. 丰富的选项合并策略 new Vue是运行Vue框架的第一步，Vue作为构造器，实例化阶段的第一步是执行初始化过程，而选项合并是初始化的开始。我们会向构造器中传递各种类型的可配置选项，例如data,props,或者像mounted这类生...",
    'cover': undefined,
    'sidebar': [
        {
            "text": "目录",
            "link": "src/0.Introduction.html",
            "pagePath": "src/0.Introduction.md"
        },
        {
            "text": "1.丰富的选项合并策略",
