 ...
 * @Description  :
 * @LastEditors  : HyFun
 * @LastEditTime : 2021-09-15 13:31:24
 */
export default {
    srcDir: '.',
    exclude: ['LICENSE'],
    ...
    head: (React.createElement(React.Fragment, null,
        React.createElement("link", { rel: "icon", href: "/src/assets/favicon.ico" }))),
    nav: [
        {
            text: 'Vue2.x文档',
            target: '_blank',
        ...
        },
        {
            ...
            popover: (React.createElement(React.Fragment, null,
                React.createElement("img", { src: "/src/assets/wechat.png", width: "256", style: { marginRight: '1rem', verticalAlign: 'top' } }),
                React.createElement("img", { src: "/src/assets/alipay.png", width: "256", style: { verticalAlign: 'top' } })))
        }
        // {
        //   text: 'About',
